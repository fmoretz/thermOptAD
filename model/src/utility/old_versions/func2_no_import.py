...
def phi0(tau, d_r, species):
    ...
    if species == 'O2':
        ...
        phi_id = log(d_r / d0) + OX[0] * tau ** 1.5 + OX[1] / tau ** 2 + OX[2] * mt.log(tau) \
                 + OX[3] * tau + OX[4] * mt.log(mp.exp(tau * OX[6]) - 1) + OX[5] \
        ...
        phi_id = log(d_r) + a[species][0] + a[species][1] * tau + a[species][2] * mt.log(tau) + a[species][3] * (
